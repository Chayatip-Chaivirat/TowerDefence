...
namespace Tower_Defence
{
    public class Tower
    {
        ...
        public Tower(Vector2 pos, string type, Economy economy)
        {
            this.towerPos = pos;
            this.towerTexRec = new Rectangle(0, 0, 150, 150);
            this.towerType = type;
            this.towerLevel = 1; // Initialize the tower level to 1 when a new tower is created
